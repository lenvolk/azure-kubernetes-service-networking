...
#We can use nslookup or dig to investigate the DNS record, it's CNAME @10.0.0.10 is the cluser IP of our DNS Server
...
nslookup hello-world-clusterip.default.svc.cluster.local 10.0.0.10
...
nslookup hello-world-clusterip.ns1.svc.cluster.local 10.0.0.10
kubectl describe service hello-world-clusterip --namespace ns1
